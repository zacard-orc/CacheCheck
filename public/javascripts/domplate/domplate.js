    ...
    (function() {
        ...
        DomplateTag.prototype = {
            ...
            parseAttrs: function(args) {
                for (var name in args) {
                    ...
                    if (name.indexOf("on") == 0) {
                        ...
                        if (name == "class" && name in this.attrs) this.attrs[name] += " " + val;
            ...
            generateMarkup: function(topBlock, topOuts, blocks, info) {
                ...
                if ("class" in this.attrs || this.classes) {
                    topBlock.push(', " class=\\""');
                    if ("class" in this.attrs) addParts(this.attrs["class"], ',', topBlock, info, true);
                    topBlock.push(', " "');
            ...
            generateDOM: function(path, blocks, args) {
                ...
                if (this.listeners) {
                    for (var i = 0; i < this.listeners.length; i += 2) {
                        ...
                        if ($.browser.msie) blocks.push('node.attachEvent("', this.listeners[i], '", __bind__(this, ', arg, '));\n');
        ...
        var Renderer = {
            ...
            insertAfter: function(args, before, self) {
                ...
                if (before.nextSibling) before.parentNode.insertBefore(frag, before.nextSibling);
                else before.parentNode.appendChild(frag);
            ...
            insertCols: function(args, parent, self) {
                ...
                if (this.tag.isLoop) {
                    ...
                    for (; node && node != firstCol; node = node.nextSibling)++offset;
                }
